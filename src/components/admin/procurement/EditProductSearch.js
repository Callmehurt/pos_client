                            ...
                            selectedProduct.map((data, index) => {
                                return (
                                    <tr key={data._id}>
                                        ...
                                        <td>
                                            <input type="number" defaultValue={data?.unitPrice ? data.unitPrice : 1} min='1' className={'form-control'} onBlur={(e) => onUnitPriceChange(e, data)} onKeyUp={(e) => onUnitPriceChange(e, data)}/>
                                        </td>
                                        <td>
                                            <input type="number" defaultValue={data?.changedQuantity ? data.changedQuantity : 1} min='1' className={'form-control'} onBlur={(e) => onStockChange(e, data)} onKeyUp={(e) => onStockChange(e, data)}/>
                                        </td>
                                        <td>Rs. {
